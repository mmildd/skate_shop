...
--
-- Host: localhost
-- Generation Time: 05 มี.ค. 2022 เมื่อ 03:52 PM
...
CREATE TABLE `address` (
  ...
  `a_provinces` varchar(100) NOT NULL,
  `a_amphures` varchar(100) NOT NULL,
  `a_districts` varchar(100) NOT NULL,
  `a_zipcode` int(11) NOT NULL,
...
INSERT INTO `address` (`address_id`, `a_address`, `a_provinces`, `a_amphures`, `a_districts`, `a_zipcode`, `member_id`) VALUES
(2, '345 67', '5', '76', '140302', 13260, '2'),
(4, '123', '7', '97', '160117', 15000, '4');
...
INSERT INTO `admin` (`a_id`, `a_user`, `a_pass`, `a_name`, `datesave`, `a_email`, `a_tel`) VALUES
(1, 'pitadee', '3272ecce2e91dc1a531f530b36acd0bfeb3fa5e260e743a31f975e6b963db944f95a9260cba7d1dc87251a48f8f72807edb77f32271955b424ba7725281aacdf', 'mmildd', '2018-11-16 05:34:50', 'mild-1@hotmail.com', '0989185789'),
(20, 'supit', 'ad5021b987a2eab4f16a8e63008d190a234144982619f3f5b6c397cc44c5d40baca9f8790d395675e0c415c7e85af53a8879710bb02e12e81098d1c9af3493f7', 'mild supitsara', '2022-03-05 09:34:36', 'supit@hotmail.com', '0989185789');
...
CREATE TABLE `amphures` (
  ...
  `am_name_th` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `amphures` (`id`, `code`, `am_name_th`, `name_en`, `province_id`) VALUES
...
INSERT INTO `bank` (`b_id`, `b_name`, `b_number`, `b_uname`) VALUES
(1, 'กรุงศรี', '7774663152', 'ศุภิสรา ภักดีแก้ว'),
(2, 'กรุงไทย', '3980632547', 'ศุภิสรา ภักดีแก้ว');
...
CREATE TABLE `districts` (
  ...
  `dis_name_th` varchar(150) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `districts` (`id`, `zip_code`, `dis_name_th`, `name_en`, `amphure_id`) VALUES
...
INSERT INTO `member` (`member_id`, `m_user`, `m_pass`, `m_name`, `m_email`, `m_tel`, `date_save`) VALUES
(2, 'dee', '395548b2f525cf9a5186f966d775bb8bee3da0698d8a3cb9e6a25f913063d8eb10b20030b7f57cc2b14d68cc0494832d5990c171cda4ff927133907d819c54ac', 'dee deew', 'dee@hotmail.com', '0830225768', '2022-02-19 11:48:39'),
(4, 'ball', '4af4c7d8c04967a78cf3ccaf3536853e982b8bf87ddf268b6549cbcc3e95a12c3edd0dc0a657092c94615c94d09e44a97d4161d42ccfdb9a071e50171f37cc29', 'พงศกร เม้ยขันหมาก', 'ball@hotmail.com', '0830225769', '2022-03-05 14:12:18');
...
CREATE TABLE `order_detail` (
  ...
  `d_memberid` int(100) NOT NULL,
  `d_qty` int(100) NOT NULL,
  `d_subtotal` int(100) NOT NULL,
  `o_total` int(100) NOT NULL,
  `d_dttm` datetime NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `order_detail` (`d_id`, `o_id`, `p_id`, `d_memberid`, `d_qty`, `d_subtotal`, `o_total`, `d_dttm`) VALUES
(4, 3, 12, 2, 1, 4980, 5670, '2022-02-19 18:49:08'),
(5, 3, 22, 2, 1, 690, 5670, '2022-02-19 18:49:08'),
(15, 12, 9, 4, 1, 1999, 1999, '2022-03-05 21:13:17'),
(8, 6, 11, 2, 1, 3990, 3990, '2022-02-22 19:33:38'),
(9, 7, 7, 2, 1, 2000, 2000, '2022-03-02 01:54:31'),
(10, 8, 9, 2, 1, 1999, 1999, '2022-03-02 01:58:37'),
(11, 9, 9, 2, 1, 1999, 1999, '2022-03-05 16:31:34');

-- --------------------------------------------------------

--
-- โครงสร้างตาราง `order_head`
--

CREATE TABLE `order_head` (
  `o_id` int(100) NOT NULL,
  `o_dttm` datetime NOT NULL,
  `o_memberid` int(100) NOT NULL,
  `o_qty` int(100) NOT NULL,
  `h_total` int(100) NOT NULL,
  `o_status` int(1) NOT NULL COMMENT '1=รอชำระเงิน 2=ชำระเงินแล้ว 3=ตรวจสอบเลขems  4=ยกเลิก',
  `b_id` int(2) NOT NULL DEFAULT 0 COMMENT 'bankid',
  `o_img` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'สลิปโอนเงิน',
  `o_img_date` date NOT NULL,
  `o_img_total` float(10,2) NOT NULL DEFAULT 0.00,
  `o_ems` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
  `o_ems_date` datetime NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- dump ตาราง `order_head`
--

INSERT INTO `order_head` (`o_id`, `o_dttm`, `o_memberid`, `o_qty`, `h_total`, `o_status`, `b_id`, `o_img`, `o_img_date`, `o_img_total`, `o_ems`, `o_ems_date`) VALUES
(3, '2022-02-19 18:49:08', 2, 2, 5670, 1, 0, '', '0000-00-00', 0.00, '', '0000-00-00 00:00:00'),
(12, '2022-03-05 21:13:17', 4, 1, 1999, 3, 2, 'slip84524307520220305_211438.jpg', '2022-03-05', 1999.00, 'FF3454345435TH', '2022-03-05 21:15:13'),
(6, '2022-02-09 19:33:38', 2, 1, 3990, 2, 1, 'slip110905703420220301_231115.jpg', '2022-03-01', 3990.00, '', '0000-00-00 00:00:00'),
(7, '2022-03-02 01:54:31', 2, 1, 2000, 4, 0, '', '0000-00-00', 0.00, '', '0000-00-00 00:00:00'),
(8, '2022-03-02 01:58:37', 2, 1, 1999, 3, 1, 'slip168016811220220302_015905.jpg', '2022-03-02', 1999.00, 'AA3454345435TH', '2022-03-02 02:01:28'),
(9, '2022-03-05 16:31:34', 2, 1, 1999, 2, 1, 'slip97541369920220305_163200.jpg', '2022-03-05', 1999.00, '', '0000-00-00 00:00:00');
...
CREATE TABLE `product` (
  ...
  `p_qty` int(100) NOT NULL COMMENT 'จำนวนสินค้าในสต๊อก',
  `datesave` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `product` (`p_id`, `p_name`, `p_price`, `type_id`, `p_detail`, `p_img`, `p_qty`, `datesave`) VALUES
(7, 'skateboard แดงฟ้า', 2000, 3, 'ลายหน้าคน น้ำตาสีแดง พื้นด้านบนตัดด้วยสีดำดูลงตัว เท่ในแนวแปลกๆ555555555                                                   ', 'p_img64026911720211207_232810.png', 10, '2021-12-07 16:28:10'),
(8, 'Skate Board crisarida', 2500, 3, 'ลายหลังตำรวจ มีความเท่ๆคูลๆในตัว ด้วยสติ๊กเกอร์ที่แปะอยู่ด้านหลังเสื้อ                                       ', 'p_img189613039120211207_233022.png', 0, '2021-12-07 16:30:22'),
(9, 'Skate Board หัวใจ', 1999, 3, 'ลายคนใส่เสื้อสีแดงถือหัวใจมนุษย์ สื่อความหมายได้อย่างลึกซึ้ง', 'p_img190762214020211207_233153.png', 4, '2021-12-07 16:31:53'),
(10, 'Skate Board woman', 2500, 3, 'ลายผู้หญิงปากแดงคาบบุหรี่ ดัดด้วยพื้นสีดำดูลงตัว             ', 'p_img139594674320211207_233307.png', 11, '2021-12-07 16:33:07'),
(11, 'Roller Blade Zetra', 3990, 19, 'Zetrablade Elite W is an entry level-to-intermediate skate for women. The comfort-fit boot structure, upgraded mesh liner and 80mm Performance', 'p_img78045376220211207_233846.jpg', 5, '2021-12-07 16:38:46'),
(12, 'Roller Blade E2 110', 4980, 19, 'High performance skate for marathons and speed skating.', 'p_img165552325920211207_233949.jpg', 5, '2021-12-07 16:39:49'),
(13, 'Roller Blade Maxxum', 3400, 19, 'Rollerblade Maxxum Edge 90 Mens Adult Fitness Inline Skate, Sapphire and Orange, Premium Inline Skates', 'p_img34695190620211207_234106.jpeg', 8, '2021-12-07 16:41:06'),
(14, 'Roller Blade RB CRUISER', 3500, 19, 'ROLLERBLADE RB CRUISER URBAN INLINE SKATES 2021 - RB CRUSR BKYW', 'p_img96028999720211207_234221.jpeg', 4, '2021-12-07 16:42:21'),
(15, 'Surf Skate ขาว-แดง', 2500, 20, 'พื้นบนสีขาวคาดด้วยเส้นสีแดง', 'p_img125629475120211207_234516.png', 0, '2021-12-07 16:45:16'),
(16, 'Surf Skate green-gray', 3990, 20, 'ตัวแผ่นกระดานเล่นด้วยสีเขียว ไล่สีด้วยสีเทา', 'p_img155370903220211207_234645.png', 7, '2021-12-07 16:46:45'),
(17, 'Surf Skate skyblue', 3990, 20, 'สีฟ้าน้ำทะเลอ่อน ตัดด้วยลายไม้', 'p_img136313515420211207_234753.png', 10, '2021-12-07 16:47:53'),
(18, 'Surf Skate black', 4900, 20, 'ตัวบอร์ดสีดำ ตัดด้วยเส้นสีฟ้าเหลือง', 'p_img72124339820211207_234931.png', 12, '2021-12-07 16:49:31'),
(19, 'หมวก', 200, 1, 'หมวกสีดำ ป้องกันการกระแทก', 'p_img72238629020211207_235221.jpg', 9, '2021-12-07 16:52:21'),
(20, 'safety black', 700, 1, 'ชุดป้องกันการกระแทก เข่า ข้อศอก และมือ อย่างละคู่', 'p_img199959894520211207_235348.jpg', 6, '2021-12-07 16:53:48'),
(21, 'safety blue', 650, 1, 'ชุดป้องกันการกระแทก เข่า ข้อศอก และมือ อย่างละคู่', 'p_img151673929220211207_235426.jpg', 7, '2021-12-07 16:54:26'),
(22, 'safety pink', 690, 1, 'ชุดป้องกันการกระแทก เข่า ข้อศอก และมือ อย่างละคู่             ', 'p_img125074326120211207_235453.jpg', 4, '2021-12-07 16:54:53');
...
CREATE TABLE `provinces` (
  ...
  `pro_name_th` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `name_en` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `provinces` (`id`, `code`, `pro_name_th`, `name_en`, `geography_id`) VALUES
...
CREATE TABLE `shop` (
  ...
  `g_img` varchar(200) NOT NULL,
  `h_address` varchar(200) DEFAULT NULL,
  `h_tel` varchar(12) DEFAULT NULL,
  `h_fb` varchar(200) DEFAULT NULL,
  `h_ig` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `shop` (`h_id`, `h_name`, `g_img`, `h_address`, `h_tel`, `h_fb`, `h_ig`) VALUES
(1, 'SKATE SHOP', '93635076620220222_173651.PNG', 'สนามคาสเซิล ต.ในเมือง อ.เมือง  จ.บุรีรัมย์ 31000', '098-918-6789', 'skateplus buriram', 'skb skateplus buriram');
