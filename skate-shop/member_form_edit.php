...
<div class="row">
  <div class="col-md-2">
    <div class="list-group">
          ...
          <a href="#" class="list-group-item list-group-item-action" style="background-color: #cbbbe9;">Order  <i class="fas fa-box-open"></i></a>
    </div>
  </div>
  ...
  <div class="col-md-2">
    ...
    <input type="hidden" name="member_id" value="<?php echo $member_id; ?>"> 
      <div class="card border-secondary" style="width: 30rem;">
        <div class="card-body">
        <p class="card-text"><h4>แก้ไขข้อมูล</h4></p>
        </div>
        ...
        <div class="card-body">
          <div class="col-sm-12" align="left">
            ...
            Username : <input  name="m_user" type="text" required class="form-control" id="m_user" value="<?=$m_user;?>" placeholder="Username" pattern="^[a-zA-Z0-9]+$" title="ภาษาอังกฤษหรือตัวเลขเท่านั้น" minlength="2"  />
            </div>
          </div><p>
        
          <div class="col-sm-12" align="left">
            <div class="col-sm-6" align="left"> 
            Password : <input  name="m_pass" type="password" required class="form-control" id="m_pass"  value="<?=$m_pass;?>" placeholder="Password" pattern="^[a-zA-Z0-9]+$" minlength="2" />
            </div>
          </div><p>
        
          <div class="col-sm-12" align="left">
            <div class="col-sm-6" align="left"> 
            Name : <input  name="m_name" type="text" required class="form-control" id="m_name" value="<?=$m_name;?>" placeholder="ชื่อ-สกุล " />
            </div>
          </div><p>
        
          <div class="col-sm-12" align="left">
            <div class="col-sm-6" align="left"> 
            Email : <input  name="m_email" type="email" class="form-control" id="m_email"  value="<?=$m_email;?>" placeholder=" อีเมล์ example@hotmail.com"/>
            </div>
          </div><p>
       
          <div class="col-sm-12" align="left">
            <div class="col-sm-6" align="left"> 
            Tell :  <input  name="m_tel" type="text" class="form-control" id="m_tel" value="<?=$m_tel;?>" placeholder="เบอร์โทร ตัวเลขเท่านั้น" />
            </div>
          </div>
        </div><p>
